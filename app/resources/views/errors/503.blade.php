...
<title>Maintenance en cours · FamFer</title>

{{--
  Cette page est volontairement autonome, comme celle de la panne 500.

  Elle n'étend pas le gabarit du site, et ce n'est pas une négligence : le
  gabarit interroge la base de données pour composer la barre des rayons. Or
  une maintenance coupe précisément la base et le cache — s'appuyer sur le
  gabarit déclencherait donc une erreur à l'intérieur de la page qui sert à
...
<div class="boite">
  ...
  <p>
    FamFer est momentanément fermé pour une mise à jour. C'est prévu, c'est
    court, et le catalogue revient d'ici quelques minutes.
  </p>
  <p>
  ...
  <a href="/" class="btn">Réessayer maintenant</a>
</div>
